...
def test_known_cells_s17():
    ...
    assert basic_strategy(8, False, True, 5, ALL, Rules(double_after_split=False)) == H
...
def test_basic_strategy_beats_random_and_edge_is_small():
    ...
    # true value is about -0.4% of the initial bet; allow generous Monte-Carlo slack
    assert -0.02 < stats.ev_per_round < 0.01
